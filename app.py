...
# Pickup longitude
with col1:
    pickup_longitude = st.number_input('Insert the longitude where you need to be pickup', format='%.6f', min_value=-74.02, max_value=-73.92, step=.000001)

# Pickup latitude
with col2:
    pickup_latitude = st.number_input('Insert the latitude where you need to be pickup', format='%.6f', min_value=40.70, max_value=40.88,step=.000001)

# Pickup longitude
with col1:
    dropoff_longitude = st.number_input('Insert the longitude where you need to be dropoff', format='%.6f', min_value=-74.02, max_value=-73.92, step=.000001)

# Pickup latitude
with col2:
    dropoff_latitude = st.number_input('Insert the latitude where you need to be dropoff', format='%.6f', min_value=40.70, max_value=40.88,step=.000001)
